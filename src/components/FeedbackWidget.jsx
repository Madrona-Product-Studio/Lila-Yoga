...
const PROMPTS = {
  loved: { label: 'What made it land?', placeholder: "e.g. 'the pose instructions were clear and easy to follow'" },
  okay:  { label: 'What would push this further?', placeholder: "e.g. 'would love a way to save my favorite sequences'" },
  off:   { label: 'What got in the way?', placeholder: "e.g. 'the video wouldn't play on my phone'" },
};
