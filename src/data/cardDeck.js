...
export const CARDS = [
  ...
  },
  {
    ...
    tradition: 'Hinduism & Yoga',
    name: 'Prānāyāma',
    subtitle: 'Breath as the bridge between body and mind',
  ...
  },
  {
    ...
    teaching: 'The Stoic practice of meditating on death — not morbidly but as the primary instrument of presence. Marcus Aurelius returned to it constantly in his Meditations. Seneca returned to this urgency throughout his letters. When you know this moment will end, it becomes vivid. The light on that canyon wall will not look like this again. This exact configuration of cloud and silence and the particular ache in your legs — never again. Mortality does not diminish beauty. It is what makes beauty sharp. Memento mori is not a practice of grief. It is a practice of attention.',
  ...
  },
  {
    ...
    teaching: "Shinrin-yoku — forest bathing — is the Japanese practice of therapeutic immersion in forest. Not hiking, not exercise, not destination. Just being inside the living atmosphere of trees. Research confirms what the Taoists knew: the forest is doing something to you whether you attend to it or not. It lowers cortisol, slows the breath, and quiets the part of the mind that plans and narrates. The practice is simply to stop moving fast enough to receive what is already being offered. The forest doesn't need your attention to function. But your attention is what makes it medicine.",
